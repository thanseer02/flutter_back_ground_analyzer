...
mixin _$AnalyticsEvent {
 ...
 String get eventId; String get sessionId; String? get userId; DateTime get timestamp; DateTime get deviceTime; String get timezone; String? get screenName; EventType get eventType; Map<String, dynamic> get metadata; String get appVersion; String get buildNumber; String get platform; String get osVersion; String get deviceModel; String get locale; String get networkType; int? get batteryLevel;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,eventId,sessionId,userId,timestamp,deviceTime,timezone,screenName,eventType,const DeepCollectionEquality().hash(metadata),appVersion,buildNumber,platform,osVersion,deviceModel,locale,networkType,batteryLevel);

@override
String toString() {
  return 'AnalyticsEvent(eventId: $eventId, sessionId: $sessionId, userId: $userId, timestamp: $timestamp, deviceTime: $deviceTime, timezone: $timezone, screenName: $screenName, eventType: $eventType, metadata: $metadata, appVersion: $appVersion, buildNumber: $buildNumber, platform: $platform, osVersion: $osVersion, deviceModel: $deviceModel, locale: $locale, networkType: $networkType, batteryLevel: $batteryLevel)';
}
...
@useResult
$Res call({
 String eventId, String sessionId, String? userId, DateTime timestamp, DateTime deviceTime, String timezone, String? screenName, EventType eventType, Map<String, dynamic> metadata, String appVersion, String buildNumber, String platform, String osVersion, String deviceModel, String locale, String networkType, int? batteryLevel
});
...
/// Create a copy of AnalyticsEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? eventId = null,Object? sessionId = null,Object? userId = freezed,Object? timestamp = null,Object? deviceTime = null,Object? timezone = null,Object? screenName = freezed,Object? eventType = null,Object? metadata = null,Object? appVersion = null,Object? buildNumber = null,Object? platform = null,Object? osVersion = null,Object? deviceModel = null,Object? locale = null,Object? networkType = null,Object? batteryLevel = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String eventId,  String sessionId,  String? userId,  DateTime timestamp,  DateTime deviceTime,  String timezone,  String? screenName,  EventType eventType,  Map<String, dynamic> metadata,  String appVersion,  String buildNumber,  String platform,  String osVersion,  String deviceModel,  String locale,  String networkType,  int? batteryLevel)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AnalyticsEvent() when $default != null:
return $default(_that.eventId,_that.sessionId,_that.userId,_that.timestamp,_that.deviceTime,_that.timezone,_that.screenName,_that.eventType,_that.metadata,_that.appVersion,_that.buildNumber,_that.platform,_that.osVersion,_that.deviceModel,_that.locale,_that.networkType,_that.batteryLevel);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String eventId,  String sessionId,  String? userId,  DateTime timestamp,  DateTime deviceTime,  String timezone,  String? screenName,  EventType eventType,  Map<String, dynamic> metadata,  String appVersion,  String buildNumber,  String platform,  String osVersion,  String deviceModel,  String locale,  String networkType,  int? batteryLevel)  $default,) {final _that = this;
switch (_that) {
case _AnalyticsEvent():
return $default(_that.eventId,_that.sessionId,_that.userId,_that.timestamp,_that.deviceTime,_that.timezone,_that.screenName,_that.eventType,_that.metadata,_that.appVersion,_that.buildNumber,_that.platform,_that.osVersion,_that.deviceModel,_that.locale,_that.networkType,_that.batteryLevel);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String eventId,  String sessionId,  String? userId,  DateTime timestamp,  DateTime deviceTime,  String timezone,  String? screenName,  EventType eventType,  Map<String, dynamic> metadata,  String appVersion,  String buildNumber,  String platform,  String osVersion,  String deviceModel,  String locale,  String networkType,  int? batteryLevel)?  $default,) {final _that = this;
switch (_that) {
case _AnalyticsEvent() when $default != null:
return $default(_that.eventId,_that.sessionId,_that.userId,_that.timestamp,_that.deviceTime,_that.timezone,_that.screenName,_that.eventType,_that.metadata,_that.appVersion,_that.buildNumber,_that.platform,_that.osVersion,_that.deviceModel,_that.locale,_that.networkType,_that.batteryLevel);case _:
  return null;
...
class _AnalyticsEvent implements AnalyticsEvent {
  const _AnalyticsEvent({required this.eventId, required this.sessionId, this.userId, required this.timestamp, required this.deviceTime, required this.timezone, this.screenName, required this.eventType, final  Map<String, dynamic> metadata = const {}, required this.appVersion, required this.buildNumber, required this.platform, required this.osVersion, required this.deviceModel, required this.locale, required this.networkType, this.batteryLevel}): _metadata = metadata;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,eventId,sessionId,userId,timestamp,deviceTime,timezone,screenName,eventType,const DeepCollectionEquality().hash(_metadata),appVersion,buildNumber,platform,osVersion,deviceModel,locale,networkType,batteryLevel);
...
/// Create a copy of AnalyticsEvent
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? eventId = null,Object? sessionId = null,Object? userId = freezed,Object? timestamp = null,Object? deviceTime = null,Object? timezone = null,Object? screenName = freezed,Object? eventType = null,Object? metadata = null,Object? appVersion = null,Object? buildNumber = null,Object? platform = null,Object? osVersion = null,Object? deviceModel = null,Object? locale = null,Object? networkType = null,Object? batteryLevel = freezed,}) {
